...
class KDRManager
{
    ...
    public static function updateKdr(string $playerName, int $kills, int $deaths) {
    ...
    public static function resetKdr($player) {
    ...
    public static function formatKdr($kdrValue) {
        if ($kdrValue === null) {
            return "N/A";
        }
    ...
    {
        $json = file_get_contents(Utils::getConfigurations("kdr")->getPath());
