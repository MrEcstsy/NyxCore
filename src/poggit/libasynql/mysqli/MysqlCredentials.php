...
use main\src\poggit\libasynql\ConfigException;
use main\src\poggit\libasynql\SqlError;
use mysqli;
use function strlen;
...
class MysqlCredentials implements JsonSerializable{
	...
	/**
	 * Creates a new {@link \src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\mysqli\MysqlCredentials} instance from an array (e.g. from Config), with the following defaults:
	 * <pre>
	 * host: 127.0.0.1
	 * username: root
	 * password: ""
	 ...
	 * @return main\src\poggit\libasynql\mysqli\MysqlCredentials
	 * @throws main\src\poggit\libasynql\ConfigException If <code>schema</code> is missing and <code>$defaultSchema</code> is null/not passed
	 */
	public static function fromArray(array $array, ?string $defaultSchema = null) : main\src\poggit\libasynql\mysqli\MysqlCredentials{
		if(!isset($defaultSchema, $array["schema"])){
			throw new ConfigException("The attribute \"schema\" is missing in the MySQL settings");
		}
		return new main\src\poggit\libasynql\mysqli\MysqlCredentials(
	...
	/**
	 * Constructs a new {@link \src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\mysqli\MysqlCredentials} by passing parameters directly.
	 *
	 * @param string $host
	 ...
	 * @return mysqli
	 *
	 * @throws main\src\poggit\libasynql\SqlError
	 */
