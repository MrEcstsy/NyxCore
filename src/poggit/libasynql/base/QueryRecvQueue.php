...
class QueryRecvQueue extends ThreadSafe{
	...
	/**
	 * @param main\src\poggit\libasynql\SqlResult[] $results
	 */
	...
	/**
	 * @param main\src\poggit\libasynql\SqlError|main\src\poggit\libasynql\SqlResult[]|null $results
	 */
	...
	/**
	 * @return list<array{int, main\src\poggit\libasynql\SqlError|SqlResults[]|null}>
	 */
