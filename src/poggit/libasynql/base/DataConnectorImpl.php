...
use main\src\poggit\libasynql\generic\GenericStatementFileParser;
use main\src\poggit\libasynql\GenericStatement;
...
class DataConnectorImpl implements DataConnector{
	/** @var Plugin */
	private $plugin;
	/** @var main\src\poggit\libasynql\SqlThread */
	private $thread;
	/** @var Logger|null */
	private $logger;
	/** @var main\src\poggit\libasynql\GenericStatement[] */
	private $queries = [];
	/** @var callable[] */
	private $handlers = [];
	/** @var int */
	...
	/**
	 * @param Plugin      $plugin
	 * @param main\src\poggit\libasynql\SqlThread   $thread      the backend SqlThread to connect with
