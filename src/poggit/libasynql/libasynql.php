...
use main\src\poggit\libasynql\base\DataConnectorImpl;
use main\src\poggit\libasynql\base\SqlThreadPool;
use main\src\poggit\libasynql\mysqli\MysqlCredentials;
use main\src\poggit\libasynql\mysqli\MysqliThread;
use main\src\poggit\libasynql\sqlite3\Sqlite3Thread;
...
final class libasynql{
	...
	public static function create(PluginBase $plugin, $configData, array $sqlMap, bool $logQueries = null) : DataConnector{
		main\src\poggit\libasynql\libasynql::detectPackaged();
		...
		$connector = new DataConnectorImpl($plugin, $pool, $placeHolder, $logQueries ?? !main\src\poggit\libasynql\libasynql::isPackaged());
