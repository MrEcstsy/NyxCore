...
use Logger;
use main\src\poggit\libasynql\generic\GenericStatementFileParseException;
use main\src\poggit\libasynql\result\SqlColumnInfo;
...
interface DataConnector{
	 ...
	 *
	 * @throws main\src\poggit\libasynql\generic\GenericStatementFileParseException if the file contains a syntax error or compile error
	 ...
	 * @param string  $queryName the {@link GenericPreparedStatement} query name
	 * @param mixed[] $args      the variables as defined in the {@link GenericPreparedStatement}
	 * @return Generator<mixed, \src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\libs\SOFe\AwaitGenerator\Await::RESOLVE|\src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\libs\SOFe\AwaitGenerator\Await::REJECT, mixed, null>
	 */
	 ...
	 * @param string  $queryName the {@link GenericPreparedStatement} query name
	 * @param mixed[] $args      the variables as defined in the {@link GenericPreparedStatement}
	 * @return Generator<mixed, \src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\libs\SOFe\AwaitGenerator\Await::RESOLVE|\src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\libs\SOFe\AwaitGenerator\Await::REJECT, mixed, int>
	 */
	 ...
	 * @param string  $queryName the {@link GenericPreparedStatement} query name
	 * @param mixed[] $args      the variables as defined in the {@link GenericPreparedStatement}
	 * @return Generator<mixed, \src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\libs\SOFe\AwaitGenerator\Await::RESOLVE|\src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\libs\SOFe\AwaitGenerator\Await::REJECT, mixed, array{int, int}>
	 */
	 ...
	 * The generator returns the number of affected rows.
	 *
	 * If {@link main\src\poggit\libasynql\result\SqlColumnInfo} is needed, use `asyncSelectWithInfo` instead.
	 *
	 * @param string  $queryName the {@link GenericPreparedStatement} query name
	 * @param mixed[] $args      the variables as defined in the {@link GenericPreparedStatement}
	 * @return Generator<mixed, \src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\libs\SOFe\AwaitGenerator\Await::RESOLVE|\src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\libs\SOFe\AwaitGenerator\Await::REJECT, mixed, array[] $rows>
	 */
	 ...
	 * @param string  $queryName the {@link GenericPreparedStatement} query name
	 * @param mixed[] $args      the variables as defined in the {@link GenericPreparedStatement}
	 * @return Generator<mixed, \src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\libs\SOFe\AwaitGenerator\Await::RESOLVE|\src\Vecnavium\SkyBlocksPM\libs\poggit\libasynql\libs\SOFe\AwaitGenerator\Await::REJECT, mixed, array{array[], main\src\poggit\libasynql\result\SqlColumnInfo[]}>
	 */
