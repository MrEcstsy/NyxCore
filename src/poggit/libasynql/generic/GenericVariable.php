...
class GenericVariable implements JsonSerializable{
	...
	public function unlist() : main\src\poggit\libasynql\generic\GenericVariable{
		if(!$this->list){
	...
	public function equals(main\src\poggit\libasynql\generic\GenericVariable $that, &$diff = null) : bool{
