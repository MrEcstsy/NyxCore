...
use main\src\poggit\libasynql\SqlDialect;
...
abstract class GenericStatementImpl implements GenericStatement, JsonSerializable{
	 ...
	 * @param int               $lineNo
	 * @return main\src\poggit\libasynql\generic\GenericStatementImpl
	 */
	public static function forDialect(string $dialect, string $name, array $query, string $doc, array $variables, ?string $file, int $lineNo) : main\src\poggit\libasynql\generic\GenericStatementImpl{
		static $classMap = [
